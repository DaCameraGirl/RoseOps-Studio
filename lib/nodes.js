...
function createNodeRegistry(credentials) {
  ...
  const nodeTypes = {
    ...
    llm: {
      ...
      config: [
        { key: "provider", label: "Provider", type: "select", options: ["openai", "google", "deepseek", "xai", "ollama"], default: "openai" },
        { key: "credentialId", label: "API Key", type: "credential", credentialTypes: ["openai_api", "google_gemini", "deepseek_api", "xai_grok", "ollama_local", "bearer_token"], default: "" },
