...
function createNodeRegistry(credentials) {
  ...
  const nodeTypes = {
    ...
    llm: {
      ...
      config: [
        { key: "provider", label: "Provider", type: "select", options: ["openai", "google", "deepseek", "xai", "anthropic", "azure", "ollama"], default: "openai" },
        { key: "credentialId", label: "API Key", type: "credential", credentialTypes: ["openai_api", "google_gemini", "deepseek_api", "xai_grok", "anthropic_api", "azure_openai", "ollama_local", "bearer_token"], default: "" },
